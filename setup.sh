...
IPVPS=$(curl -sS https://raw.githubusercontent.com/Santaibos/izin_new/main/ip | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Casper2
else
...
mkdir /root/casper
cd /root/casper
wget https://raw.githubusercontent.com/Santaibos/izin_new/main/ip >/dev/null 2>&1
...
res1() {
wget https://raw.githubusercontent.com/Santaibos/new/main/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
...
clear
wget https://raw.githubusercontent.com/Santaibos/new/main/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
res2() {
wget https://raw.githubusercontent.com/Santaibos/new/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
} 

res3() {
wget https://raw.githubusercontent.com/Santaibos/new/main/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}

res4() {
wget https://raw.githubusercontent.com/Santaibos/new/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
}

res5() {
wget https://raw.githubusercontent.com/Santaibos/new/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
}

res6() {
#wget https://raw.githubusercontent.com/Santaibos/new/main/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

res7() {
wget https://raw.githubusercontent.com/Santaibos/new/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}

res8() {
wget https://raw.githubusercontent.com/Santaibos/new/main/slowdns/installsl.sh && chmod +x installsl.sh && bash installsl.sh
clear
}

res9() {
wget https://raw.githubusercontent.com/Santaibos/new/main/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear
}
res10() {
wget https://raw.githubusercontent.com/Santaibos/new/main/noobz/noobzvpns.zip
unzip noobzvpns.zip
chmod +x noobzvpns/*
cd noobzvpns
bash install.sh
...
res11() {
#wget https://raw.githubusercontent.com/Santaibos/new/main/bin/limit.sh && chmod +x limit.sh && ./limit.sh
clear
}

res12() {
#wget https://raw.githubusercontent.com/Santaibos/new/main/install/ins-trgo.sh && chmod +x ins-trgo.sh && bash ./ins-trgo.sh
wget -q -O /etc/crontab "https://raw.githubusercontent.com/Santaibos/new/main/install/crontab" && chmod 644 /etc/crontab
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/Santaibos/izin_new/main/ip | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Santaibos/new/main/versi  )
