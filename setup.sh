...
res7() {
wget https://raw.githubusercontent.com/warouhh/new/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/warouhh/new/main/versi  )
