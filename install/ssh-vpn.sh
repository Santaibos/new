...
curl -sS https://raw.githubusercontent.com/warouhh/new/main/install/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
curl https://raw.githubusercontent.com/warouhh/new/main/install/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/warouhh/new/main/install/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/warouhh/new/main/install/index.html1"
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/sbin/badvpn "https://raw.githubusercontent.com/warouhh/new/main/install/badvpn" >/dev/null 2>&1
chmod +x /usr/sbin/badvpn > /dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn1.service "https://raw.githubusercontent.com/warouhh/new/main/install/badvpn1.service" >/dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn2.service "https://raw.githubusercontent.com/warouhh/new/main/install/badvpn2.service" >/dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn3.service "https://raw.githubusercontent.com/warouhh/new/main/install/badvpn3.service" >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/warouhh/new/main/install/dosflate.zip
unzip dosflate.zip
...
# Ganti Banner
wget -O /etc/issue.net "https://raw.githubusercontent.com/warouhh/new/main/install/issue.net"
...
# download script
cd /usr/bin
wget -O issue "https://raw.githubusercontent.com/warouhh/new/main/install/issue.net"
wget -O m-theme "https://raw.githubusercontent.com/warouhh/new/main/menu/m-theme.sh"
wget -O speedtest "https://raw.githubusercontent.com/warouhh/new/main/install/speedtest_cli.py"
