...
curl -sS https://raw.githubusercontent.com/Santaibos/new/main/install/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
curl https://raw.githubusercontent.com/Santaibos/new/main/install/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/Santaibos/new/main/install/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/Santaibos/new/main/install/index.html1"
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/sbin/badvpn "https://raw.githubusercontent.com/Santaibos/new/main/install/badvpn" >/dev/null 2>&1
chmod +x /usr/sbin/badvpn > /dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn1.service "https://raw.githubusercontent.com/Santaibos/new/main/install/badvpn1.service" >/dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn2.service "https://raw.githubusercontent.com/Santaibos/new/main/install/badvpn2.service" >/dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn3.service "https://raw.githubusercontent.com/Santaibos/new/main/install/badvpn3.service" >/dev/null 2>&1
...
apt -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/Santaibos/new/main/install/main/squid3.conf"
...
#OpenVPN
wget https://raw.githubusercontent.com/Santaibos/new/main/install/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh

#OpenVPNwebsocket
#apt install golang-go
#wget https://raw.githubusercontent.com/Santaibos/new/main/sshws/ovpn-websocket.sh &&  chmod +x ovpn-websocket.sh && ./ovpn-websocket.sh
#go run ovpn-websocket.sh


# // install lolcat
wget https://raw.githubusercontent.com/Santaibos/new/main/install/lolcat.sh &&  chmod +x lolcat.sh && ./lolcat.sh
...
wget https://raw.githubusercontent.com/Santaibos/new/main/install/dosflate.zip
unzip dosflate.zip
...
# Ganti Banner
wget -O /etc/issue.net "https://raw.githubusercontent.com/Santaibos/new/main/install/issue.net"

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/Santaibos/new/main/install/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
# download script
cd /usr/bin
wget -O issue "https://raw.githubusercontent.com/Santaibos/new/main/install/issue.net"
wget -O m-theme "https://raw.githubusercontent.com/Santaibos/new/main/menu/m-theme.sh"
wget -O speedtest "https://raw.githubusercontent.com/Santaibos/new/main/install/speedtest_cli.py"
